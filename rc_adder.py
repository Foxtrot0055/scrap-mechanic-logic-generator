...
def full_adder(pos_x, pos_y, pos_z, carry_out):
    cout = sm.make.logic_gate(pos_x, pos_y, pos_z, [carry_out], [2,1], 1)
    s = sm.make.logic_gate(pos_x, pos_y+1, pos_z, None, [2,1], 2)
    ...
    a = sm.make.logic_gate(pos_x+2,pos_y,pos_z,[ab, ac, s])
    b = sm.make.logic_gate(pos_x+2,pos_y+1,pos_z,[ab, bc, s])
    cin = sm.make.logic_gate(pos_x+2,pos_y+2,pos_z,[ac, bc, s])
